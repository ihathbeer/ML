# Credit: Mo Han (TA)
# Note: changed it a bit to use pyplot as opposed to pylab (drw)
# Note2: changed it some more to fit requirements of assignment 4 question 1
import numpy as np
